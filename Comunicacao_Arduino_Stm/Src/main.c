...
uint8_t TxData[8]; //foi declarado do começo que estamos testando com 12 bytes
uint8_t RxData[8]; //por isso os dados tem que ter 12 de tamanho de array
...
int main(void)
{
  ...
  //Code do Otavio
    ...
    TxHeader.DataLength = FDCAN_DLC_BYTES_8; // Comprimento dos dados: 12 bytes
    ...
    TxHeader.FDFormat = FDCAN_CLASSIC_CAN; // Formato CAN FD
