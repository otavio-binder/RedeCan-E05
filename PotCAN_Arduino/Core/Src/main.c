...
uint16_t TxMailbox;
uint8_t TxData[8]; //foi declarado do começo que estamos testando com 8 bits e é um uint8_t
uint8_t RxData[8]; //por isso os dados tem que ter 16 de tamanho de array 0 a 255
/* USER CODE END PV */
