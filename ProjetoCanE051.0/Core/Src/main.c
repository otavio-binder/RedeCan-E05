...
uint16_t TxMailbox;
uint8_t TxData[6]; //foi declarado do começo que estamos testando com 8 bits e é um uint8_t
uint8_t RxData[6]; //por isso os dados tem que ter 8 de tamanho de array
/* USER CODE BEGIN PV */
typedef struct {
    uint16_t PotLin;
    uint16_t PotLog;
